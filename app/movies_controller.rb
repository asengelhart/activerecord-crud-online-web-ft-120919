...
def can_be_found_updated_and_saved
  ...
  my_movie = Movie.find_by(title: "Awesome Flick")
  my_movie.title = "Even Awesomer Flick"
  my_movie.save
end
...
def can_update_using_update_method
  ...
  my_movie = Movie.find_by(title: "Wat?")
  my_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  a_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  a_movie.delete
end
